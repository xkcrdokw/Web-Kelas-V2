  ...
  return (
    <div className="text-white px-[10%]" id="Home">
      ...
      <div className="lg:hidden">
        ...
        <div className="text-sm text-center pb-15">2023 - 2026</div>
      ...
      <div className="hidden lg:block">
        <div className="flex justify-center items-center flex-col h-[100vh]">
          ...
          <h1 className="text-7xl font-extrabold" id="Glow"> WELCOME </h1>
          <h6 className="text-sm" style={{ letterSpacing: "5px" }}> TO XI TKR 4 </h6>
        </div>
      </div>
    </div>
  )
