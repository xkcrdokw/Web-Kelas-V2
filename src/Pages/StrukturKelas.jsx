  ...
  return (
    <div className="z-1 relative h-auto lg:overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div data-aos="fade-up" data-aos-duration="120" className="relative top-[-8rem]">
          <img src="LineVertikal2.svg" alt="" className="relative top-[-3.8rem]" />
        </div>
        <div className="flex gap-[5rem] relative top-[-8rem] lg:gap-[22rem]" data-aos="fade-up" data-aos-duration="1200">
          <div className="flex-col">
