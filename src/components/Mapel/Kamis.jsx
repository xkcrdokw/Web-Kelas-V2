  ...
  return (
    <>
      ...
      <div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
        <div className="w-[50%] text-base font-medium">CHS</div>
        <div className="flex justify-center items-center text-sm">09.05-09.45</div>
      </div>
      ...
      <div className="border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1000">
        <div className="w-[50%] text-base font-medium">CHS</div>
        <div className="flex justify-center items-center text-sm">12.15-13.25</div>
      </div>
      <div className="border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1100">
        <div className="w-[50%] text-base font-medium">CAD</div>
        <div className="flex justify-center items-center text-sm">13.25-15.10</div>
      </div>
    </>
  )
}
